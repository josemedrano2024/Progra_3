...
def main():
    ...
    for _ in range(2):  # Permitir registrar 2 cuadernos
        ...
        cantidad_hojas = int(input("Ingresa la cantidad de hojas (50 o 100): "))
        precio_compra = float(input("Ingresa el precio de compra del cuaderno: "))
    ...
    for _ in range(2):  # Permitir registrar 2 lápices
        print("\nRegistro de Lápiz")
        tipo = input("Ingresa el tipo de lápiz (Grafito o Colores): ")
        precio_compra = float(input("Ingresa el precio de compra del lápiz: "))
    ...
    print("\nTodos los artículos han sido registrados con éxito.")
